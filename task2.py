...
# 4. Задайте список, заполненный числами из промежутка [-N, N]. Сдвиньте все элементы списка на 2 позиции вправо.
# 3 -> [2, 3, -3, -2, -1, 0, 1]
print(f'4. Список [-N , N], сдвиг элементов на 2 позиции вправо.')
def Move_elements():
    N = int(input('Введите N для заполнения списка [-N, N]: '))
    list = []
    ...
    print(f'Полученный после сдвига: {list[:len(list)-2]}')
